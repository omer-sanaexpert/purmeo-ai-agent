...
from dotenv import load_dotenv
from purmeo_tools import purmeo_escalate_human, purmeo_query_kb
from tools import purmeo_get_product_information, purmeo_get_order_information,escalate_to_human_email_italy, escalate_to_human_ig_germany, escalate_to_human_email_spain,escalate_to_human_germany, escalate_to_human_ig_italy,escalate_to_human_whatsapp_spain,escalate_to_human_whatsapp_italy, get_instagram_user_from_psid, get_thread_id_from_ticket_id,send_insta,escalate_to_human,escalate_to_human_italy,escalate_to_human_ig_spain, get_order_information_by_email, get_order_information_by_orderid, get_product_information, send_insta_it, send_insta_de, user_conversations, requests_and_tickets,llm
...
part_1_tools_germany = [get_order_information_by_orderid,get_order_information_by_email, get_product_information, query_knowledgebase_sanaexpert, escalate_to_human_germany]
